...
export const FICHAS: FichaDocumento[] = [
  ...
  { codigo: "F-06", nombre: "Carátula y checklist maestro", categoria: "FORMATO", etapa: "Expediente", descripcion: "La carátula madre del expediente: lleva el checklist maestro y la casilla de estatus. Su casilla «Listo para venta» es la ÚNICA que autoriza emitir C-01 y C-02 (regla de oro)." },
...
export const DEPENDENCIAS: Dependencia[] = [
  ...
  { de: "F-06", a: "C-01", etiqueta: "casilla LISTO (regla de oro)" },
  { de: "F-06", a: "C-02", etiqueta: "casilla LISTO (regla de oro)" },
