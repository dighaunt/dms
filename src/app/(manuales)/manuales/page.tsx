      ...
      <DocsBody className="max-w-none">
        ...
        <section className="not-prose mt-10">
          ...
          <p className="mt-1 max-w-2xl text-sm leading-relaxed text-muted-foreground">
            El indice lateral agrupa todas las partes de ambos manuales. El buscador encuentra conceptos dentro de las reglas y abre su pagina; en movil, el indice aparece en el encabezado de manuales.
          </p>
        </section>
      </DocsBody>
    </DocsPage>
