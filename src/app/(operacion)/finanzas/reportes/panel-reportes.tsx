...
type Props = {
  ...
  filtro: RangoReporte;
  panel: PanelReportes;
  /** El rango de la URL no era válido y se cayó al del mes en curso. */
  rangoInvalido: boolean;
};

const TODAS = "todas";

/** Todo importe se imprime como en el papel: "$ 12,345.67". */
...
/**
 * Un reporte sin filas se explica con palabras. Una tabla vacía obliga a quien
 * la mira a adivinar si no hubo movimientos o si el filtro está mal puesto, y
 * esa duda es exactamente lo que un reporte de control interno no debe dejar.
 */
...
function Ingresos({ datos }: { datos: PanelReportes["ingresos"] }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* La unidad en consignación nunca fue de la empresa: el comisionista no
          adquiere la propiedad. Por eso este bloque va aparte del cuadro de
          ingresos y no se suma a él. */}
      <Card>
        <CardHeader>
