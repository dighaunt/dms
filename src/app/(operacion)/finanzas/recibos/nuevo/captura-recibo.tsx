...
/** Las denominaciones del peso mexicano, de mayor a menor. */
...
/**
 * Captura del CACM-RCI-01, en el mismo orden del papel: Parte I la operación y
 * el vendedor, Parte II el arqueo, Parte III la declaración.
 *
 * El panel de la derecha es la pieza que el papel no tiene y que aquí importa:
 * enseña el arqueo cuadrando o descuadrando MIENTRAS se captura. En papel el
 * descuadre se descubre al sumar a mano, casi siempre cuando el vendedor ya se
 * fue; aquí se ve en el momento, que es cuando todavía se puede contar de
 * nuevo el fajo.
 */
export function CapturaRecibo({ sucursales, empleados, conceptos }: Props) {
  ...
  async function guardar() {
    ...
    try {
      ...
      // 2) Cabecera y arqueo van juntos: en el papel son la misma hoja.
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
      ...
      {/* Resumen vivo: el arqueo frente a lo declarado, siempre a la vista. */}
