...
export default async function NuevoReciboPage() {
  ...
  // Sin sucursal no hay folio posible, y sin empleado no hay quién entregue el
  // efectivo. Decirlo aquí evita que alguien capture media hoja y se estrelle
  // al guardar.
  if (sucursales.length === 0 || empleados.length === 0) {
    return (
      <div className="space-y-6">
        <h1 className="text-2xl font-semibold tracking-tight">Recibo de Caja Interno</h1>
        <Card>
          <CardHeader>
