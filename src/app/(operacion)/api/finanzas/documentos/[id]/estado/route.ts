...
/**
 * Avance del folio por su máquina de estados.
 *
 * Cancelar exige motivo porque el folio queda ocupado: en papel una forma
 * inutilizada se archiva con su explicación, no se tira. La base impone la
 * longitud mínima; aquí solo se encamina la acción.
 */
